...
requirejs.config({
  paths: {
    ...
    'highlight-yaml': 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.5.1/languages/yaml.min',
    ...
    'highlight-llvm': 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.5.1/languages/llvm.min',
  },
  shim: {
  "highlight-julia": {
    "deps": [
...
////////////////////////////////////////////////////////////////////////////////
require(['jquery', 'highlight', 'highlight-julia', 'highlight-julia-repl', 'highlight-llvm', 'highlight-yaml'], function($) {
$(document).ready(function() {
    hljs.highlightAll();
})
