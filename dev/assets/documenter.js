...
requirejs.config({
  paths: {
    ...
    'highlight-llvm': 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.15.10/languages/llvm.min',
  },
  shim: {
  "highlight-julia": {
    "deps": [
...
////////////////////////////////////////////////////////////////////////////////
require(['jquery', 'highlight', 'highlight-julia', 'highlight-julia-repl', 'highlight-llvm', 'highlight-yaml'], function($, hljs) {
$(document).ready(function() {
