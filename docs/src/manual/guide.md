...
cartesian2cylinderial(PVector(sqrt(2), sqrt(2), 1.0, u"m"))
cylinderial2cartesian(2.0u"m", pi/4, 1.0u"m")
spherical2cylinderial(PVector(sqrt(0.5), sqrt(0.5), 1.0, u"m"))
spherical2cartesian(sqrt(2)u"m", pi/4, pi/4)
